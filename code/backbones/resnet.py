...
def get_resnet_parts(img_feature_dim, part1_end_idx=7):
    base_model = resnet18(pretrained=True)
    base_model.fc2 = nn.Linear(1000, img_feature_dim)

    resnet_layers = list(base_model.children())
    resnet_part1 = nn.Sequential(*resnet_layers[:part1_end_idx])
    resnet_part2 = nn.Sequential(*resnet_layers[part1_end_idx:])
    return (resnet_part1, resnet_part2)
